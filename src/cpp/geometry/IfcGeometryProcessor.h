...
namespace webifc::geometry
{
  ...
  class IfcGeometryProcessor 
  {
      public:
        ...
        IfcGeometryProcessor(const webifc::parsing::IfcLoader& loader, const webifc::schema::IfcSchemaManager& schemaManager, uint16_t circleSegments, bool coordinateToOrigin, bool applyScaling);
